export const Auction_Registration_Rejected_Template = `
<!DOCTYPE html>
<html>
<head>
<style>
...
<div class="container">
    ...
    <div class="content">
        ...
        <p>Your registration payment for <strong>{auctionName}</strong> was rejected.</p>
        <p>Please retry the payment to participate in the auction.</p>
    </div>
