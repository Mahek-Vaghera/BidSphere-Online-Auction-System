export const Auction_Verified_Email_Template = `
<!DOCTYPE html>
<html>
<head>
<style>
...
<body>
<div class="container">
    <div class="header"> Auction Approved for Listing </div>

    <div class="content">
        <p>Hello <strong>{name}</strong>,</p>
        <p>Your auction has been successfully verified by the admin.</p>
        <p><strong>Auction:</strong> {auctionName}</p>
        <p>Your auction is now live and users can start participating.</p>
    </div>
